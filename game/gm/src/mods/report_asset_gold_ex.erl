...
select(_Mod, List, _StartIndex, _SortKey, _SortType, _SqlEx) ->
    ...
    Sql = <<"select asset_id, v, count_roles from report_asset_gold where c_times >= ", Times/binary, " and c_times < ", Times/binary, " + 86400 and channel_id = ", ChannelId/binary, ";">>,
